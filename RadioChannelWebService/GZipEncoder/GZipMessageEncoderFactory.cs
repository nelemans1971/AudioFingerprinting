...
namespace GZipEncoder
{
    ...
    internal class GZipMessageEncoderFactory : MessageEncoderFactory
    {
        ...
        {
            static string GZipContentType = "application/xml; charset=utf-8";
            ...
            private static bool UseGZIPCompression
            {
                get
                {
                    if (System.ServiceModel.Web.WebOperationContext.Current != null)
                    {
                        string headerValue = System.ServiceModel.Web.WebOperationContext.Current.OutgoingResponse.Headers["Content-Encoding"];
                        return (headerValue == "gzip");
                    }
            ...
            static ArraySegment<byte> CompressBuffer(ArraySegment<byte> buffer, BufferManager bufferManager, int messageOffset)
            {
                ...
                // see fix: http://stackoverflow.com/questions/4416177/how-to-compress-http-requests-from-wcf-net-at-the-transport-level
                ArraySegment<byte> byteArray = new ArraySegment<byte>(bufferedBytes, messageOffset, totalLength);
                
                /* http://social.msdn.microsoft.com/Forums/vstudio/en-US/8c3eafae-b6a1-441f-85ef-90721d941a1a/wcf-rest-webhttpbinding-compatible-client-gzip-compression-decompress-web-responses-from-server?forum=wcf
                 * byteArray = new ArraySegment<byte>(bufferedBytes, messageOffset, compressedBytes.Length);
                */
                return byteArray;
            }
